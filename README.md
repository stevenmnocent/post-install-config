...
<p>
1. Go to the admin panel → Agents → Roles → Click add new roles.
</p>
<br />
...
<p>
2. Call the new role Senior Administrator.
</p>
<br />
...
<p>
3. Select all permissions for the senior administrator in Tickets, Tasks, and Knowledgebase tabs, and click add role.
</p>
<br />
...
<p>
4. Go to Departments → Add new department.
</p>
<br />
...
<p>
5. Name the department System Administrators and click create Dept.
</p>
<br />
...
<p>
7. Name the team Level II Support → Add yourself as a team member and click create team.
</p>
<br />
...
<p>
9. Add 3 new agents by filling out the text input fields under account.
</p>
<br />
...
<p>
10. Click set password, then uncheck “Send the agent a password reset email.”
</p>
<br />
...
<p>
11. Enter in a password and click set.
</p>
<br />
...
<p>
12. For Agent 1 under the “Access” tab assign them to the system admin department with a senior administrator role. For extended access add them to support.
</p>
<br />
...
<p>
13. Keep all permissions under the “permissions” tab the same and for teams, add Agent 1 to the level II support.
</p>
<br />
...
<p>
14. For Agent 2, add them to the Support department with an “Expanded Access” role and no Extended access.
</p>
<br />
...
<p>
15. Keep all the permissions the same and add Agent 2 to the Level I Support team and click create.
</p>
<br />
...
<p>
16. Create Agent 3 and for access choose “Maintenance” as their department, “senior administrator” for their role and no extended Access.
</p>
<br />
...
<p>
17. Add Agent 3 to the Level II Support and click create.
</p>
<br />
...
<p>
18. Go to the Agent panel → Users → Then add user to add the users that are going to be creating support tickets.
</p>
<br />
...
<p>
19. Create 2 users by filling out the text input fields and clicking add user.
</p>
<br />
...
<p>
20. To create SLA’s (Service-level agreements) go back to the admin panel.
</p>
<br />
...
<p>
21. Go to Manage, then SLA and create 3 different SLA’s by clicking “Add new SLA Plan.”
</p>
<br />
...
<p>
22. For SLA 1, call it SEV-A and for grace period put 1 hour on a 24/7 schedule, and click “Add Plan.”
</p>
<br />
...
<p>
23. For SLA 2, call it SEV-B with a 4 hour grace period on a 24/7 schedule.
</p>
<br />
...
<p>
24. For the last SLA, which is less severe, name it SEV-C with 8 hour grace period, Monday through Friday 8 AM – 5 PM.
</p>
<br />
...
<p>
25. Next, create a few different help topics by clicking the “Help Topics” tab.
</p>
<br />
...
<p>
26. Click on “Add new help topic” and for the topic put “Personal Computer Issues” and click on “Add topic.”
</p>
<br />
...
<p>
27. Add 3 more help topics for the following:
- Password Reset
- Equipment  Reset
